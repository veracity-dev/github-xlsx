...
// The Following columns will be displayed "title","number","state","author","body","url","milestone","label","comment_body","comment_createdAt","comment_author","comment_author_resource_path","comment_author_url"
const fields = [
  {
    value: "node.title",
    label: "title"
